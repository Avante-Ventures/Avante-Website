      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            "The pattern that repeats is the [copilot to data to fund flywheel](/library/copilot-to-data-to-fund-flywheel). Build an AI copilot for a service vertical, use it to generate proprietary data, then use that data to raise and deploy capital. Nexa Tech runs it in the Brazilian judicial-debt market. WIR runs it in insurance pricing and risk scoring. BR Auction Intel runs it in real estate auction intelligence.",
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            "O padrão que se repete é o [flywheel copilot, dado, capital](/library/copilot-to-data-to-fund-flywheel). Construa um copilot de IA para um vertical de serviço, use-o para gerar dado proprietário e use esse dado para captar e alocar capital. A Nexa Tech roda isso no mercado de dívida judicial brasileiro. A WIR roda em precificação e risco de seguros. A BR Auction Intel roda em inteligência de leilões imobiliários.",
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            "El patrón que se repite es el [flywheel copilot, dato, capital](/library/copilot-to-data-to-fund-flywheel). Construya un copilot de IA para un vertical de servicio, úselo para generar dato propietario y use ese dato para levantar y desplegar capital. Nexa Tech lo corre en el mercado de deuda judicial brasileño. WIR lo corre en precificación y riesgo de seguros. BR Auction Intel lo corre en inteligencia de subastas inmobiliarias.",
