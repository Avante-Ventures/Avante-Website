...
const SEO_COPY = {
  en: {
    title: "Avante Ventures: AI-native Venture Builder in Brazil",
  ...
  pt: {
    title: "Avante Ventures: Venture Builder AI-Native no Brasil",
  ...
  es: {
    title: "Avante Ventures: Venture Builder AI-Native en Brasil",
