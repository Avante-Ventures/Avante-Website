...
export const VENTURES = {
  ...
  risk: { name: 'WIR Innovation', url: 'https://wirinnovation.ai/', domain: 'wirinnovation.ai', logo: '/world-assets/wir-mark.svg', preview: '/world-assets/wir-mark.svg', website: '/world-assets/wir-website', height: 550 },
} as const;
