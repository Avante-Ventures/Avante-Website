...
const TICKS: TickItem[] = [
  ...
  ['team track record', '$500MM+ invested', 'track record do time', '$500MM+ investidos', 'track record del equipo', '$500MM+ invertidos'],
  ...
  ['offices', 'SP · SF · BOG', 'escritórios', 'SP · SF · BOG', 'oficinas', 'SP · SF · BOG'],
