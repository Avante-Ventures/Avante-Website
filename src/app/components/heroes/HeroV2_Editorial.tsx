// V2.2 — EDITORIAL ASYMMETRIC (a16z magazine-cover energy)
//
// Breaks the centered-symmetry of every other VC site. 60/40 split:
// LEFT 60% — wordmark + headline + CTAs (the marketing pitch).
// RIGHT 40% — a stack of 3 "feature cards" that act like a magazine
// table-of-contents: latest market report, latest playbook, recent
// portfolio milestone. Each card is clickable and routes to real
// content (Library articles).
//
// Why this beats v1: structural change, not decoration. The hero is
// no longer a centered statement — it's a layout that's already
// doing work (driving readers into Library articles + signaling
// activity). And it earns that complexity by being navigable, not
// by adding motion.
...
// Featured cards — keep these editorial (small + punchy)
const FEATURES = [
  {
    kind: 'MARKET REPORT',
...
export function HeroV2_Editorial() {
  ...
  return (
    ...
    >
      {/* Soft brand glow top-right corner */}
      <div
        aria-hidden
        style={{
          position: 'absolute',
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          >
            One essay per month → join the Library
          </div>
        </div>
      </div>
